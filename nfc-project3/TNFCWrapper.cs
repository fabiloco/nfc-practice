...
namespace NFC_Wrapper_Sample
{
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst=12)] public byte[] Address; 
    }

    [StructLayout(LayoutKind.Sequential, Size = 84)]
    public struct TMessageInfo
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst=64)] public string ReaderName;
